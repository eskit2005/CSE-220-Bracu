public class Task4 {
    ...
    public static Node task4B_recursive(Node prev, Node current, Node next) {
        if (current == null) {
            return prev;
        }
